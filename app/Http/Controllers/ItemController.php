...
class ItemController extends Controller
{
    ...
    {
        $items = ItemsIn::where('type_item', 'inventaris')->get();
        return view('items.items_in.index_iventaris', compact('items'));
    }

    public function indexBahan()
    {
        $items = ItemsIn::where('type_item', 'bahan')->get();
        return view('items.items_in.index_bahan', compact('items'));
    }
